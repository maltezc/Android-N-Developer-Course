...
public class MainActivity extends AppCompatActivity {
    ...
    public class DownloadTask extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... urls) {
            ...
            try {
                url = new URL(urls[0]); // should be surrounded by try/catch incase it fails.
        ...
        @Override
        protected void onPostExecute(String result) { // is called when doInBackground has completed
